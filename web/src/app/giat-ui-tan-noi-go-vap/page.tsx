...
import { Phone, MessageCircle, CheckCircle, ArrowLeft, MapPin } from "lucide-react";
...
const steps = [
  { n: "01", title: "Đặt Lịch", desc: "Gọi hoặc Zalo, cho biết địa chỉ và khung giờ thuận tiện." },
