...
const WARD = "Thông Tây Hội";
const OLD_WARDS = "Phường 8, Phường 9 và Phường 11 cũ";
const SLUG = "giat-say-thong-tay-hoi-go-vap";

export const metadata: Metadata = {
  title: `Giặt Sấy Phường ${WARD} Gò Vấp - Cửa Hàng Chính`,
  description: `Cửa hàng chính Giặt Sấy 24h Gò Vấp đặt tại phường ${WARD} (sáp nhập từ ${OLD_WARDS}). Nhận giao tận nơi trong ${BUSINESS.responseTime}. Từ ${BUSINESS.priceFrom}. Hotline: ${BUSINESS.hotline}.`,
  keywords: [
    "giặt sấy phường thông tây hội gò vấp",
    "giặt sấy phường 8 gò vấp",
    "giặt sấy phường 9 gò vấp",
    "giặt sấy phường 11 gò vấp",
    "giặt đồ gần đây gò vấp",
  ],
  alternates: { canonical: `https://www.giatsay24hgovap.com/${SLUG}` },
  openGraph: {
    title: `Giặt Sấy Phường ${WARD} Gò Vấp - Cửa Hàng Chính`,
    description: `Cửa hàng chính Giặt Sấy 24h Gò Vấp tại phường ${WARD}. Từ ${BUSINESS.priceFrom}. Nhận giao tận nơi.`,
  ...
  twitter: {
    ...
    title: `Giặt Sấy Phường ${WARD} Gò Vấp - Cửa Hàng Chính`,
    description: `Cửa hàng chính Giặt Sấy 24h Gò Vấp tại phường ${WARD}. Từ ${BUSINESS.priceFrom}.`,
  },
};
...
const faqs: FAQItem[] = [
  {
    ...
    a: `Đúng. Phường ${WARD} được sáp nhập từ ${OLD_WARDS}. Cửa hàng chính của chúng tôi đặt ngay tại đây, phục vụ trực tiếp không qua trung gian vận chuyển xa.`,
  },
  {
    q: "Có thể mang đồ trực tiếp tới cửa hàng không?",
    a: `Có. Cửa hàng đặt tại ${BUSINESS.address}, mở cửa ${BUSINESS.hours}. Bạn có thể mang đồ tới trực tiếp hoặc gọi hotline để được lấy tận nơi.`,
  },
  {
    q: "Lấy và giao đồ mất bao lâu?",
    a: `Vì là cửa hàng chính, thời gian lấy đồ trong khu vực Phường ${WARD} thường nhanh hơn, trong khoảng ${BUSINESS.responseTime}.`,
  },
  {
...
const nearbyWards = [
  ...
  { href: "/giat-say-an-nhon-go-vap", name: "An Nhơn" },
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <FadeIn direction="up">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 text-sm text-cyan-200 font-medium mb-6">
              <MapPin size={14} /> Cửa hàng chính — Phường {WARD}, Gò Vấp
            </div>
          </FadeIn>
          <FadeIn direction="up" delay={0.15}>
            <h1 className="text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6">
              Giặt Sấy Phường {WARD} —{" "}
              <span className="shimmer-text">Cửa Hàng Chính</span>
            </h1>
            <p className="text-slate-300 text-lg leading-relaxed mb-8 max-w-2xl">
              Cửa hàng chính của Giặt Sấy 24h Gò Vấp đặt tại Phường {WARD} ({OLD_WARDS}). Nhận và giao tận nhà, từ <strong className="text-white">{BUSINESS.priceFrom}</strong>.
            </p>
            <ul className="space-y-2 mb-10">
              {[`Cửa hàng chính đặt ngay tại Phường ${WARD} (${OLD_WARDS})`, `Lấy đồ trong ${BUSINESS.responseTime}, giao đúng hẹn`, "Có thể mang đồ trực tiếp tới cửa hàng hoặc gọi lấy tận nơi"].map((p) => (
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <SectionHeader label="Cửa hàng chính" title={`Phường ${WARD}, Gò Vấp`} wrapperClass="mb-10" />
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 text-sm text-blue-800 leading-relaxed">
            Phường {WARD} được sáp nhập từ {OLD_WARDS}. Đây chính là nơi đặt cửa hàng của Giặt Sấy 24h Gò Vấp ({BUSINESS.address}), mở cửa {BUSINESS.hours}. Vì là cửa hàng chính, thời gian lấy giao đồ trong khu vực này thường nhanh hơn các phường khác.
          </div>
        </div>
      </section>
