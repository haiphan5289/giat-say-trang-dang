...
const WARD = "An Hội Tây";
const OLD_WARDS = "Phường 12 và Phường 14 cũ";
const SLUG = "giat-say-an-hoi-tay-go-vap";
...
export const metadata: Metadata = {
  ...
  keywords: [
    "giặt sấy phường an hội tây gò vấp",
    "giặt sấy phường 12 gò vấp",
    "giặt sấy phường 14 gò vấp",
