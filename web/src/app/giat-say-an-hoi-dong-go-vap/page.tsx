...
const WARD = "An Hội Đông";
const OLD_WARDS = "Phường 15 và Phường 16 cũ";
const SLUG = "giat-say-an-hoi-dong-go-vap";
...
export const metadata: Metadata = {
  ...
  keywords: [
    "giặt sấy phường an hội đông gò vấp",
    "giặt sấy phường 15 gò vấp",
    "giặt sấy phường 16 gò vấp",
